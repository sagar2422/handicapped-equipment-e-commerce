...
function Login() {
	...
	return (
		...
		{error !== '' ? <div className='flex align-middle justify-center items-center gap-2 cursor-pointer align-start w-[5/6] bg-dark-purple text-white px-8 py-4 rounded-md shadow-md' onClick={()=>setError('')}>{error} <IoMdClose size={30}/></div>:<div></div>}
